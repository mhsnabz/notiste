...
public class ScientistSinglePostActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_scientist_single_post);
      ...
      //  lessonName=getIntent().getStringExtra("lessonName");
        ...
        upload_list.setLayoutManager(new GridLayoutManager(ScientistSinglePostActivity.this,3,GridLayoutManager.VERTICAL,false));
       ...
       notification.put("name",name);
        ...
        dbMap.put("type","Yeni Bir Not Paylaştı");
        dbMap.put("time",-1*Calendar.getInstance().getTimeInMillis());
        dbMap.put("seen","false");
        dbMap.put("sender",name);


        load(profilePicture,_tv_lessonName,tv_username,image,lessonKey,name,major);
    ...
    private void setDatabaseNotification(String _major,String _userId,String _key)
    {
    ...
    private void openFileSelection()
    {
        ...
        {
            Toast.makeText(ScientistSinglePostActivity.this,"Bişeyler Ters Gitti",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable final Intent data) {
        ...
        if(requestCode == FILE_SELECT_CODE && resultCode == RESULT_OK){
            ...
            if(data.getClipData() != null){
                ...
                Toast.makeText(ScientistSinglePostActivity.this, "HATA", Toast.LENGTH_SHORT).show();
    ...
    private void load(CircleImageView pic, final TextView tv_lessonName, TextView tv_username, String image, String _lessonKey, String name,String _major)
    {
