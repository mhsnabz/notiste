...
public class PostNoteScientistActivity extends AppCompatActivity {


    Toolbar toolbar;
    RecyclerView lessons;
    String major,current_user,name,image;
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_post_note_scientist);
        SetToolbar();
        ...
        lessons.setLayoutManager(new GridLayoutManager(PostNoteScientistActivity.this,1));
    ...
    private void setLessons(final String _major, final String _currentUser)
    {
        ...
        FirebaseRecyclerAdapter<LessonsName,ViewHolderLessons> adapter = new FirebaseRecyclerAdapter<LessonsName, ViewHolderLessons>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolderLessons holder, final int position, @NonNull final LessonsName model)
            {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    {
                        Intent intent = new Intent(PostNoteScientistActivity.this, ScientistSinglePostActivity.class);
            ...
            @NonNull
            @Override
            public ViewHolderLessons onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
