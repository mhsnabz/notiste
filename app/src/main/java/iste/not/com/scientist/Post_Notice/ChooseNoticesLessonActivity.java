...
public class ChooseNoticesLessonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_notices_lesson);
        SetToolbar();
        ...
        lessons.setLayoutManager(new GridLayoutManager(ChooseNoticesLessonActivity.this,1));
        ...
        FirebaseRecyclerAdapter<LessonsName,ChoosLessonViewHolderLessons> adapter = new FirebaseRecyclerAdapter<LessonsName, ChoosLessonViewHolderLessons>(options) {
            ...
            protected void onBindViewHolder(@NonNull final ChoosLessonViewHolderLessons holder, final int position, @NonNull final LessonsName model)
            {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    {
                        Intent intent = new Intent(ChooseNoticesLessonActivity.this,ScientistPostNoticesActivity.class);
                        intent.putExtra("query","notices");
